...
class GenerateClustersSpec extends Specification {
  ...
  docSet +=  (1 -> DocumentVector(Map(A -> dist01, B -> dist06)))
  docSet +=  (2 -> DocumentVector(Map(A -> dist01, B -> dist06)))
  docSet +=  (3 -> DocumentVector(Map(B -> dist06, C -> dist02)))
  docSet +=  (4 -> DocumentVector(Map(B -> dist06, C -> dist02, D -> dist04)))
  docSet +=  (5 -> DocumentVector(Map(D -> dist04)))

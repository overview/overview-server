...
class DanglingNodeDeleterSpec extends DbSpecification {
  ...
  "DanglingNodeDeleter" should {
    "delete root Nodes" in new DbScope {
    ...
    "not delete non-dangling Nodes" in new DbScope {
    ...
    "delete child Nodes" in new DbScope {
      import database.api._
    ...
    "not delete children of non-dangling Nodes" in new DbScope {
      import database.api._
    ...
    "delete NodeDocuments" in new DbScope {
      import database.api._
    ...
    "not delete NodeDocuments of non-dangling Nodes" in new DbScope {
      val documentSet = factory.documentSet()
      val document = factory.document(documentSetId=documentSet.id)
      val node1 = factory.node()
    ...
    "delete the DanglingNode" in new DbScope {

...
case class User(
  ...
  val role: UserRole.UserRole = UserRole.NormalUser,
  ...
  val resetPasswordToken: Option[String] = None,
  val resetPasswordSentAt: Option[Timestamp] = None,
  val lastActivityAt: Option[Timestamp] = None,
  val lastActivityIp: Option[String] = None,

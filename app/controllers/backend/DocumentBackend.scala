...
import org.overviewproject.models.tables.{DocumentInfos,DocumentInfosImpl,Documents,DocumentsImpl,DocumentSearchResults,DocumentTags,DocumentVizObjects,NodeDocuments,Tags}

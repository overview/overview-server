define [ 'jquery', 'backbone', 'apps/DocumentCloudImportForm/models/DocumentCloudQuery' ], ($, Backbone, Query) ->
  describe 'apps/DocumentCloudImportForm/models/DocumentCloudQuery', ->
    describe 'url()', ->

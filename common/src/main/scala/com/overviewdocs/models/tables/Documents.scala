...
class DocumentsImpl(tag: Tag) extends Table[Document](tag, "document") {
  ...
  def * = (
    ...
    pdfNotes,
    text
  ).<>[Document,Tuple17[Long,Long,Option[String],Option[String],Option[String],Option[String],Option[Int],Seq[String],Date,Option[Long],Option[Long],Option[DocumentDisplayMethod.Value],Option[Boolean],Option[JsObject],Option[String],Option[PdfNoteCollection],Option[String]]](

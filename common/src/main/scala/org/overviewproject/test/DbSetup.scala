...
object DbSetup {
  ...
  def insertCsvImportDocumentSet(uploadedFileId: Long)(implicit c: Connection): Long = {
    SQL("""
      INSERT INTO document_set (public, title, uploaded_file_id, created_at, document_count, document_processing_error_count, import_overflow_count, lang, supplied_stop_words, important_words, version)
  ...
  def insertDocumentSet(query: String)(implicit c: Connection): Long = {
    SQL("""
      INSERT INTO document_set (public, title, query, created_at, document_count, document_processing_error_count, import_overflow_count, lang, supplied_stop_words, important_words, version)

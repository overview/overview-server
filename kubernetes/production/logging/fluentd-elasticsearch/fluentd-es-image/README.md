...
# Overview-specific edits:

* `out_overview_sns.rb`: fluentd plugin to push errors to Amazon SNS
* Docker Hub holds our image at `overview/overview-fluentd-es:latest`

...
require [
  'jquery'
  'for-view/DocumentSet/_show/models/animated_tree'
  'for-view/DocumentSet/_show/models/observable'
  'for-view/DocumentSet/_show/models/on_demand_tree'
  'for-view/DocumentSet/_show/models/animator'
  'for-view/DocumentSet/_show/models/property_interpolator'
], ($, AnimatedTree, observable, OnDemandTree, Animator, PropertyInterpolator) ->
  Deferred = $.Deferred
  ...
  describe 'models/animated_tree', ->
    describe 'AnimatedTree', ->
      ...
      it 'should have children and loaded and unloaded nodes when resolved', ->
        add_nodes([
          [1, [2], 3],
          [2, [4], 3]
        ])

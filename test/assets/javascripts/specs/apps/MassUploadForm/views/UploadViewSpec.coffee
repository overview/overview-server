define [
  ...
  describe 'apps/MassUploadForm/views/UploadView', ->
    ...
    describe 'waiting', ->
      ...
      it 'has a wait icon', -> expect(view.$el).toContainElement('i.icon-time')
      ...
      describe 'transitioning to uploading', ->
        ...
        it 'has a spinner', -> expect(view.$el).toContainElement('i.icon-spin.icon-spinner')
    ...
    describe 'fully uploaded', ->
      ...
      it 'has an ok icon', -> expect(view.$el).toContainElement('i.icon-ok')
